...
public class EntityRMRunnerExpansion extends QueryRunner {
	...
	public EntityRMRunnerExpansion(IndexWrapper targetIndex, SearchHitsBatch initialResultsBatch, Stopper stopper,
