...
import edu.gslis.entities.docscoring.ScorerDirichletCategoryNoCollection;
...
public class RunEntityBackedRetrievalNoCollection {
	...
	public static void main(String[] args) {
		...
		ScorerDirichletCategoryNoCollection scorer = new ScorerDirichletCategoryNoCollection();
